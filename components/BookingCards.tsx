  ...
  return (
    <section className="rounded-2xl border bg-white p-5 shadow-sm">
      ...
      <p className="mt-1 text-sm text-slate-500">
        Comparez puis réservez auprès de nos partenaires. Les liens affiliés sont utilisés
        uniquement lorsqu'un compte partenaire est configuré.
      </p>
      ...
      <div className="mt-4 grid gap-3 sm:grid-cols-2">
        ...
        >
          ...
          <span className="mt-1 block text-xs font-normal opacity-90">Europe ↔ Maroc</span>
        </button>
      </div>
    </section>
  );

...
const DEFAULT_SUGGESTIONS: TopicKey[] = [
  'route',
  'prayer',
  'ferry',
  'cost',
    ...
    <>
      ...
      {open && (
        ...
        >
                ...
                >
                  ...
                  <div
                    className={`max-w-[78%] rounded-2xl px-4 py-2.5 text-sm leading-relaxed ${
                      msg.role === 'user' ? 'text-[#0d3f38] font-medium' : 'text-white/95'
                    }`}
                    style={{
                      background:
                        msg.role === 'user'
              ...
              >
                ...
                >
                  ...
                  <span
                    className="h-2 w-2 rounded-full bg-[#eead59]"
                    style={{
                      animation: 'hadak-typing 1.2s infinite ease-in-out',
                      animationDelay: '0.2s',
                    }}
                  />
                  <span
          ...
          {/* ---- Input area ---- */}
          <div className="p-3" style={{ borderTop: '1px solid rgba(238, 173, 89, 0.12)' }}>
